...
export class HomePage {
  ...
  places: any[] = [{name: 'Clínica 1', street: 'Rua 1',number: 1, img: 'assets/imgs/clinicas/clinica1.jpeg', distance: 4.7},
                   {name: 'Clínica 2', street: 'Rua 2',number: 2, img: 'assets/imgs/clinicas/clinica2.png', distance: 8.3},
                   {name: 'Clínica 3', street: 'Rua 3',number: 3, img: 'assets/imgs/clinicas/clinica3.jpg', distance: 3.5},
                   {name: 'Clínica 4', street: 'Rua 4',number: 4, img: 'assets/imgs/clinicas/clinica4.jpg', distance: 10.1}]
